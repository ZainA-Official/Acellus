...
GEMINI_SYSTEM_INSTRUCTION = (
    ...
    "  For 'fill_in':\n"
    "    Acellus has TWO kinds of fill-in elements -- do NOT confuse them:\n"
    "      (a) Small [?] boxes INSIDE the equation display -- these are visual\n"
    "          placeholders only. Clicking them does nothing useful.\n"
    "      (b) A DARK TEXT INPUT BAR at the very BOTTOM of the question card,\n"
    "          just above the Submit button -- this is the REAL typing field.\n"
    "    ALWAYS set target_box around element (b), the dark bottom input bar.\n"
    "    NEVER point target_box at the [?] boxes inside the equation.\n\n"
    "    When you see multiple [?] boxes in the equation, look at their COLOR:\n"
    "      GREEN (highlighted) = the box being asked RIGHT NOW. Answer only this one.\n"
    "      GRAY = future questions that will be asked separately later. Ignore them.\n"
    "    Always set answer to the single value for the GREEN box only (e.g. '2').\n"
    "    Never return comma-separated multi-part answers.\n\n"
