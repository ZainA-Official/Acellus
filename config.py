...
GEMINI_SYSTEM_INSTRUCTION = (
    ...
    "    If there is ONE blank: set answer to that single value (e.g. '2').\n"
    "    If there are MULTIPLE blanks (multiple [?] boxes in the equation):\n"
    "      List ALL answers left-to-right, comma-separated, no spaces (e.g. '2,-2,4').\n"
    "      The bot types each value and presses Tab to advance to the next blank.\n\n"
